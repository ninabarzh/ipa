...
2. Set it up on a safe device. Use a phone or tablet that’s *not* shared or previously handled by anyone else. If that’s not possible, do a device check first (see device control guides).
...
6. Bonus: set up a decoy account. If you're in a situation where someone expects access to a certain account, you can set up a secondary email or social profile with harmless content.
...
6. Check auto-forwarding and filters. Some accounts allow messages to be secretly forwarded elsewhere. Look under your email settings and filters for anything you didn’t set up.
...
2. Pick a low-profile email address. Use something neutral, without your full name or any personal hints. Example: `paperlantern.mailbox@proton.me`
...
6. Use aliases if needed. Some email services let you create disposable addresses that still reach your inbox. Handy if you want to give an email out temporarily or keep your main one under wraps.
